...
<img class="media-object" src="{{url('uploads/profile/'.$comment->user->image)}}" width="64" height="64">
         ...
         <a target="_blank" href="">
          <img class="media-object" src="{{url('uploads/profile/'.$comment->user->image)}}" width="64" height="64">
                                                    ...
                                                    <div class="media-body">
                                                        <a target="_blank" href="">
      <h4 class="media-heading">{{ str_limit($comment->title,'40') }}</h4>
                                                        </a>
...
<i class="material-icons"><a onclick="return confirm('Are you sure want to delete?')" href="{{ route('admin.comment.destroy',$comment->id) }}"
