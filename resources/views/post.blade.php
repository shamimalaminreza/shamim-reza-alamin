...
@push('css')
    ...
    <style>
        .header-bg{
            height: 400px;
            width: 100%;
            background-image: url({{url('uploads/post/'.$post->image)}});
...
@section('content')
                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
        <a class="avatar" href="#"><img src="{{url('uploads/profile/'.$post->user->image) }}" alt="Profile Image"></a>
                                </div>
    ...
    <section class="recomended-area section">
        <div class="container">
            ...
            <div class="blog-image"><img src="{{url('uploads/post/'.$randompost->image) }}" alt="{{ $randompost->title }}"></div>

         <a class="avatar" href="#"><img src="{{url('uploads/profile/'.$randompost->user->image) }}" alt="Profile Image"></a>
                            ...
                            <div class="commnets-area ">
                                ...
                                <div class="comment">
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="left-area">
                <a class="avatar" href="#"><img src="{{url('uploads/profile/'.$comment->user->image) }}" alt="Profile Image"></a>
                                        </div>

                                        <div class="middle-area">
                         <a class="name" href="#"><b>Name:{{ $comment->user->name }}</b></a>
                          <h6 class="date">on {{$comment->created_at->diffForHumans()}}</h6>
 <h6 class="date">Date {{$comment->created_at}}</h6><br>


 <a class="name" href="{{url('comment',$comment->id)}}"><b>Edit</a>
