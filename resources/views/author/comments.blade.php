                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
     <img class="media-object" src="{{url('uploads/profile/'.$comment->user->image) }}" width="64" height="64">
                                                        </a>
                                                    </div>
          ...
          <a target="_blank" href="">
             <img class="media-object" src="{{url('uploads/post/'.$comment->post->image)}}" width="64" height="64">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                               <a target="_blank" href="">
...
<i class="material-icons"><a onclick="return confirm('Are you sure want to delete?')" href="{{ route('author.comment.destroy',$comment->id) }}"
