...
<a onclick="return confirm('Are you sure want to Approve?')"
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
    <img class="img-responsive thumbnail" src="{{asset('uploads/post/'.$post->image)}}" alt="" style="width: 100%;height: 100%;" alt="">
                        </div>
                    </div>
